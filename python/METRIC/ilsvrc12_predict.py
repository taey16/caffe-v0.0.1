...
MODEL_GOOGLE_DEPLOY_FILE = '%s/models/bvlc_googlenet/prototxt/deploy.prototxt' % DATASET_ROOT
MODEL_GOOGLE_WEIGHT_FILE = '%s/models/bvlc_googlenet/model/bvlc_googlenet.caffemodel' % DATASET_ROOT
MODEL_VGG_DEPLOY_FILE = '%s/models/vgg/vgg_layer16_deploy.prototxt' % DATASET_ROOT
MODEL_VGG_WEIGHT_FILE = '%s/models/vgg/vgg_layer16.caffemodel' % DATASET_ROOT
