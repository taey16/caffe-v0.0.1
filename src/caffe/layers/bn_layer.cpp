...
STUB_GPU(BNLayer);
  ...
  // If you encounter following errors
  //  .build_release/tools/caffe
  //  WARNING: Logging before InitGoogleLogging() is written to STDERR
  //  F0913 22:46:17.992069 2042422016 layer_factory.hpp:68] Check failed: registry.count(type) == 0 (1 vs. 0) Layer type BN already registered.
  //  *** Check failure stack trace: ***
  //  make: *** [runtest] Abort trap: 6
  // Then comment follwoing code
